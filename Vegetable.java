...
/**
 * This class uses to add the information of the vegetables
 * @author yenhu
 *
 */
public class Vegetable extends FoodItem {
	 ...
	 */
	public Vegetable(int code, String name, float price, int num, float cost, String supName){
		super(code, name, price, num, cost);
		this.farmName = supName;
	}
